...
path2 = '/home/avi/Desktop/test_data_only/New_Preterm_Data'
path3 = '/home/avi/Desktop/test_data_only/all_data'
term_ScanAge = pd.read_csv(path1 + '/ScanGA.csv')
term_BirthAge = pd.read_csv(path1 + '/BirthGA.csv')
term_all_feat = pd.read_csv(path1 + '/ALL_FEATURES.csv')
...
preterm_all_feat = pd.read_csv(path2 + '/ALL_FEATURES.csv')
preterm_labels = pd.read_csv(path2 + '/Term_labels.csv')
all_ScanAge = pd.read_csv(path2 + '/ScanGA.csv')
all_BirthAge = pd.read_csv(path2 + '/BirthGA.csv')
all_all_feat = pd.read_csv(path2 + '/ALL_FEATURES.csv')
all_labels = pd.read_csv(path2 + '/Term_labels.csv')


best_depth = 7 # 13.4 depth OOB
best_estim = 65
training_size = 0.8 # 0.53 training size OOB
testing_size = 1 - training_size
...
testing_labels = preterm_BirthAge
training_data = term_all_feat
training_labels = term_BirthAge
...
plt.figure(1)
# plt.scatter(best_test_labels, best_pred, c='b', label='Prediction')
plt.scatter(testing_labels, pred, c='b', label='Prediction')
